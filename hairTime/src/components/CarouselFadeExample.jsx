...
function CarouselFadeExample() {
  return (
    ...
    <Carousel.Item>
      <ExampleCarouselImage text="salon" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
      <ExampleCarouselImage text="hair_styling" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
      <ExampleCarouselImage text="cut_hair" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
      <ExampleCarouselImage text="sinks" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
      <ExampleCarouselImage text="maches" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
      <ExampleCarouselImage text="hair_washing" />
      <Carousel.Caption>
        <h3>Lavaggio</h3>
        <p>
          Praesent commodo cursus magna, vel scelerisque nisl consectetur.
